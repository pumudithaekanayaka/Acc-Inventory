namespace Acc_Inventory
{
    partial class Dashboard
    {
        ...
        private void InitializeComponent()
        {
            ...
            log_lbl_dashboard.Font = new Font("Google Sans", 9F);
            ...
            // btn_received_logs
            // 
            btn_received_logs.BackColor = Color.Crimson;
            btn_received_logs.FlatAppearance.BorderSize = 0;
            btn_received_logs.FlatStyle = FlatStyle.Flat;
            btn_received_logs.Font = new Font("Google Sans", 10.2F);
            ...
            // dateTimePicker1
            // 
            dateTimePicker1.Font = new Font("Google Sans", 10.2F);
            ...
            // btn_distribute_logs
            // 
            btn_distribute_logs.BackColor = Color.Crimson;
            btn_distribute_logs.FlatAppearance.BorderSize = 0;
            btn_distribute_logs.FlatStyle = FlatStyle.Flat;
            btn_distribute_logs.Font = new Font("Google Sans", 10.2F);
            ...
            // 
            refresh_btn_dashboard.BackColor = Color.Crimson;
            refresh_btn_dashboard.FlatAppearance.BorderSize = 0;
            refresh_btn_dashboard.FlatStyle = FlatStyle.Flat;
            refresh_btn_dashboard.Font = new Font("Google Sans", 10.2F);
